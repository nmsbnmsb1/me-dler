...
class default_1 extends me_actions_1.Action {
    ...
    async doStart(context) {
        ...
        {
            try {
                this.response = await (0, utils_1.request)({ method: context.method, url: metaData.url, headers, timeout: context.timeout, responseType: 'stream' });
            }
            catch (err) {
                throw (0, utils_1.e)(1002, err.message, `${context.method.toUpperCase()}: ${metaData.url}`);
            }
        }
        {
